...
3. **Обновить `04_RESULTS.md`**
   ...
   - Добавить строку с датой/источником (например: «прогон `run_experiment.py rl full` от …»).
...
- После каждого значимого прогона (`run_experiment.py rl full`, `run_experiment.py research ...`, `main.py solve` с разными method и т.д.) имеет смысл заново проходить шаги 1–4 и обновлять 04_RESULTS и 03_HYPOTHESES.
